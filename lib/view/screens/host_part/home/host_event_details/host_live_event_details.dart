...
class HostLiveEventDetails extends StatefulWidget {
  const HostLiveEventDetails({super.key});

  @override
  State<HostLiveEventDetails> createState() => _DmLiveEventDetailsState();
}

class _DmLiveEventDetailsState extends State<HostLiveEventDetails> {
  @override
